...
router.get("/:id/public-info", middleware.authenticateDeveloperToken, async (req, res) => {
     try {
          ...
          if(room.metadata.permissions[req.user.id] == 0 || playerData.private.availableTags.includes("Developer") || playerData.private.availableTags.includes("Community Support Team")) return res.status(200).json(room.public);
